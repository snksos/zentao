...
if(isset($params['-mp']))
{
    ...
    if(file_exists("$basePath/app/zentao/config/db.php"))
    {
        `chmod 777 $basePath/app/zentao/config/db.php`;
        $myFile = "$basePath/app/zentao/config/db.php";
        changePort($myFile, $params['-mp'], $myReg);
    }
    if(file_exists("$basePath/app/zentaopro/config/db.php"))
    {
        `chmod 777 $basePath/app/zentaopro/config/db.php`;
        $myFile = "$basePath/app/zentaopro/config/db.php";
        changePort($myFile, $params['-mp'], $myReg);
    }
